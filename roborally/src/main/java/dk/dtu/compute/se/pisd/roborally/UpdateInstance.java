...
public class UpdateInstance {
    ...
    public static GameController load(GameController gameController, Load load){
        Board board = createBoard(load);
        ...
        //U think we don't need this
        //initBoardView(gameController, gameController);
    ...
    private static Board createBoard(Load load){
        Board board;
