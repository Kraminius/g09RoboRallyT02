...
public class GameRep {
    ...
    public static JSONObject game = new JSONObject();
    ...
    /*
    public void instantiateGameDefinition(int numPlayer){
        this.gameDefinition = new GameDefinition(numPlayer);
    }
         */


    public static void setGame(GameController gameController){
       game = GameJson(gameController);
    }

    public static void setJSONGame(JSONObject JsonGame){
        game = JsonGame;
    }

    public static JSONObject getJsonGame(){
        return game;
    }

    public static JSONObject GameJson(GameController controller){
    ...
    private static int getCheckpointReached(boolean[] arr){
        int reached = 0;
    ...
    public boolean checkerPlayersConnected(){
        ...
        for (int i = 0; i < gameDefinition.readyList.length; i++) {

            System.out.println("This player: " + gameDefinition.readyList[i]);

            if(!gameDefinition.readyList[i]){
                return false;
            }
        }
    ...
    public int playerNumber(){
        ...
        int i;
        for (i = 0; i < gameDefinition.readyList.length; i++) {
